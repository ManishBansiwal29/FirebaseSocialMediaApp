...
public class SocialMediaActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
        ...
        if(bitmap != null) {
            ...
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    Toast.makeText(SocialMediaActivity.this, "Uploading is Successful", Toast.LENGTH_SHORT).show();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        dataMap.put("from whom", FirebaseAuth.getInstance().getCurrentUser().getDisplayName());
        dataMap.put("image identifier",imageIdentifier);
        dataMap.put("image link",imageDownloadLink);
